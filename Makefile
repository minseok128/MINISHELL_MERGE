...
BASE		:= main signal parser/parser_set \
			   ...
			   parser/mktr_heredoc parser/trtv parser/trtv_env_expand \
			   parser/trtv_wsplit parser/trtv_redir parser/trtv_utils \
			   btin/btin_exit btin/btin_make_envsp btin/btin_cd \
			   btin/btin_echo btin/btin_env btin/btin_export btin/btin_pwd \
			   btin/btin_unset btin/btin_make_errmsg btin/btin_export_utils \
			   execute/ex_cmdsp execute/ex_cmd_loop execute/ex_execute_utils \
			   execute/ex_handle_fd execute/ex_btin_execute execute/ex_execute \
